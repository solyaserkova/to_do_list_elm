...
var author$project$Main$init = {field: '', tasks: _List_Nil, uid: 0};
var elm$core$Basics$False = {$: 'False'};
var elm$core$Basics$True = {$: 'True'};
var author$project$Main$newTask = F2(
	function (text, id) {
		return {description: text, id: id, status: false, visible: true};
	});
		...
		switch (msg.$) {
			...
			case 'AddTask':
				return _Utils_update(
					...
					{
						field: '',
						tasks: elm$core$String$isEmpty(model.field) ? model.tasks : _Utils_ap(
							model.tasks,
							_List_fromArray(
								[
									A2(author$project$Main$newTask, model.field, model.uid)
								])),
						uid: model.uid + 1
					});
			case 'DeleteAll':
			...
			case 'ToggleStatus':
				...
				return _Utils_update(
					model,
					{
						tasks: A2(elm$core$List$map, updateStatus, model.tasks)
					});
			...
			case 'ShowAll':
				var updateVisibility = function (task) {
					var _n2 = task.visible;
					if (_n2) {
						return task;
					} else {
						return _Utils_update(
				...
				return _Utils_update(
					model,
					{
						tasks: A2(elm$core$List$map, updateVisibility, model.tasks)
					});
			case 'ShowActive':
				var updateVisibility = function (task) {
					return (!task.status) ? _Utils_update(
						task,
						{visible: true}) : _Utils_update(
						task,
						{visible: false});
				};
				return _Utils_update(
...
var author$project$Main$DeleteCompleted = {$: 'DeleteCompleted'};
var author$project$Main$ShowActive = {$: 'ShowActive'};
var author$project$Main$ShowAll = {$: 'ShowAll'};
var author$project$Main$ShowCompleted = {$: 'ShowCompleted'};
...
var author$project$Main$taskItem = function (task) {
	return task.visible ? A2(
		elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$checked(task.status),
						elm$html$Html$Events$onClick(
						author$project$Main$ToggleStatus(task.id))
					]),
				_List_Nil),
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('dlt'),
						elm$html$Html$Events$onClick(
						author$project$Main$DeleteTask(task.id))
					]),
				_List_fromArray(
					[
...
var author$project$Main$tasksList = function (tasks) {
	var child = A2(elm$core$List$map, author$project$Main$taskItem, tasks);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						author$project$Main$tasksList(model.tasks)
					])),
				A2(
				elm$html$Html$button,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Main$ShowActive)
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Main$ShowCompleted)
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Main$DeleteCompleted)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('Delete Completed')
					]))
			]));
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"UpdateField":["String.String"],"AddTask":[],"DeleteAll":[],"DeleteTask":["Basics.Int"],"ToggleStatus":["Basics.Int"],"DeleteCompleted":[],"ShowAll":[],"ShowActive":[],"ShowCompleted":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));